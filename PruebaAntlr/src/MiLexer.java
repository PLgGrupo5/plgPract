...
tryAgain:
	...
	protected final void mREAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt8640>=1 ) { break _loop8640; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	public final void mCOMP1_2(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		boolean synPredMatched8674 = false;
		if (((LA(1)=='<'||LA(1)=='>') && (LA(2)=='='))) {
			int _m8674 = mark();
			synPredMatched8674 = true;
			inputState.guessing++;
			try {
				{
				mOP_COMP1(false);
				...
				synPredMatched8674 = false;
			}
			rewind(_m8674);
inputState.guessing--;
		}
		if ( synPredMatched8674 ) {
			mOP_COMP2(false);
			if ( inputState.guessing==0 ) {
				_ttype = OP_COMP2;
			}
			...
			boolean synPredMatched8676 = false;
			if (((LA(1)=='<'||LA(1)=='>') && (true))) {
				int _m8676 = mark();
				synPredMatched8676 = true;
				inputState.guessing++;
				try {
					{
					mOP_COMP1(false);
					...
					synPredMatched8676 = false;
				}
				rewind(_m8676);
inputState.guessing--;
			}
			if ( synPredMatched8676 ) {
				mOP_COMP1(false);
				if ( inputState.guessing==0 ) {
					_ttype = OP_COMP1;
				}
	...
	public final void mID_TIPO_OPIN_OPOUT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		boolean synPredMatched8680 = false;
		if (((LA(1)=='I'||LA(1)=='i') && (LA(2)=='N'||LA(2)=='n'))) {
			int _m8680 = mark();
			synPredMatched8680 = true;
			inputState.guessing++;
			try {
				{
				mOP_IN(false);
				...
				synPredMatched8680 = false;
			}
			rewind(_m8680);
inputState.guessing--;
		}
		if ( synPredMatched8680 ) {
			mTIPOENT(false);
			if ( inputState.guessing==0 ) {
				_ttype = TIPOENT;
			}
			...
			boolean synPredMatched8689 = false;
			if (((LA(1)=='I'||LA(1)=='i') && (LA(2)=='N'||LA(2)=='n'))) {
				int _m8689 = mark();
				synPredMatched8689 = true;
				inputState.guessing++;
				try {
					{
					mOP_IN(false);
					...
					synPredMatched8689 = false;
				}
				rewind(_m8689);
inputState.guessing--;
			}
			if ( synPredMatched8689 ) {
				mOP_IN(false);
				if ( inputState.guessing==0 ) {
					_ttype = OP_IN;
				}
				...
				boolean synPredMatched8691 = false;
				if (((LA(1)=='O'||LA(1)=='o') && (LA(2)=='U'||LA(2)=='u'))) {
					int _m8691 = mark();
					synPredMatched8691 = true;
					inputState.guessing++;
					try {
						{
						mOP_OUT(false);
						...
						synPredMatched8691 = false;
					}
					rewind(_m8691);
inputState.guessing--;
				}
				if ( synPredMatched8691 ) {
					mOP_OUT(false);
					if ( inputState.guessing==0 ) {
						_ttype = OP_OUT;
					}
					...
					boolean synPredMatched8696 = false;
					if (((LA(1)=='R'||LA(1)=='r') && (LA(2)=='E'||LA(2)=='e'))) {
						int _m8696 = mark();
						synPredMatched8696 = true;
						inputState.guessing++;
						try {
							{
							mTIPOREAL(false);
							...
							synPredMatched8696 = false;
						}
						rewind(_m8696);
inputState.guessing--;
					}
					if ( synPredMatched8696 ) {
						mTIPOREAL(false);
						if ( inputState.guessing==0 ) {
							_ttype = TIPOREAL;
						}
						...
						boolean synPredMatched8683 = false;
						if (((_tokenSet_1.member(LA(1))) && (true))) {
							int _m8683 = mark();
							synPredMatched8683 = true;
							inputState.guessing++;
							try {
								{
								mOP_IN(false);
								...
								synPredMatched8683 = false;
							}
							rewind(_m8683);
inputState.guessing--;
						}
						if ( synPredMatched8683 ) {
							mID(false);
							if ( inputState.guessing==0 ) {
								_ttype = ID;
							}
							...
							boolean synPredMatched8686 = false;
							if (((_tokenSet_1.member(LA(1))) && (true))) {
								int _m8686 = mark();
								synPredMatched8686 = true;
								inputState.guessing++;
								try {
									{
									mOP_IN(false);
									...
									synPredMatched8686 = false;
								}
								rewind(_m8686);
inputState.guessing--;
							}
							if ( synPredMatched8686 ) {
								mID(false);
								if ( inputState.guessing==0 ) {
									_ttype = ID;
								}
								...
								boolean synPredMatched8694 = false;
								if (((_tokenSet_1.member(LA(1))) && (true))) {
									int _m8694 = mark();
									synPredMatched8694 = true;
									inputState.guessing++;
									try {
										{
										mOP_OUT(false);
										...
										synPredMatched8694 = false;
									}
									rewind(_m8694);
inputState.guessing--;
								}
								if ( synPredMatched8694 ) {
									mID(false);
									if ( inputState.guessing==0 ) {
										_ttype = ID;
									}
									...
									boolean synPredMatched8698 = false;
									if (((_tokenSet_1.member(LA(1))) && (true))) {
										int _m8698 = mark();
										synPredMatched8698 = true;
										inputState.guessing++;
										try {
											{
											mID(false);
											...
											synPredMatched8698 = false;
										}
										rewind(_m8698);
inputState.guessing--;
									}
									if ( synPredMatched8698 ) {
										mID(false);
										if ( inputState.guessing==0 ) {
											_ttype = ID;
										}
	...
	public final void mINT_O_REAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		boolean synPredMatched8706 = false;
		if ((((LA(1) >= '1' && LA(1) <= '9')) && (_tokenSet_5.member(LA(2))))) {
			int _m8706 = mark();
			synPredMatched8706 = true;
			inputState.guessing++;
			try {
				{
				mENTERO(false);
				...
				synPredMatched8706 = false;
			}
			rewind(_m8706);
inputState.guessing--;
		}
		if ( synPredMatched8706 ) {
			mREAL(false);
			if ( inputState.guessing==0 ) {
				_ttype = REAL;
			}
	...
	public final void mWhitespace(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt8709>=1 ) { break _loop8709; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt8709++;
		} while (true);
	...
	public final void mASIG_IGUAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		boolean synPredMatched8721 = false;
		if (((LA(1)=='=') && (LA(2)=='='))) {
			int _m8721 = mark();
			synPredMatched8721 = true;
			inputState.guessing++;
			try {
				{
				mOP_AS(false);
				...
				synPredMatched8721 = false;
			}
			rewind(_m8721);
inputState.guessing--;
		}
		if ( synPredMatched8721 ) {
			mOP_IGUAL(false);
			if ( inputState.guessing==0 ) {
				_ttype = OP_IGUAL;
			}
			...
			boolean synPredMatched8723 = false;
			if (((LA(1)=='=') && (true))) {
				int _m8723 = mark();
				synPredMatched8723 = true;
				inputState.guessing++;
				try {
					{
					mOP_AS(false);
					...
					synPredMatched8723 = false;
				}
				rewind(_m8723);
inputState.guessing--;
			}
			if ( synPredMatched8723 ) {
				mOP_AS(false);
				if ( inputState.guessing==0 ) {
					_ttype = OP_AS;
				}
	...
	public final void mNOT_COMP(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		boolean synPredMatched8727 = false;
		if (((LA(1)=='!') && (LA(2)=='='))) {
			int _m8727 = mark();
			synPredMatched8727 = true;
			inputState.guessing++;
			try {
				{
				mOP_NOT(false);
				...
				synPredMatched8727 = false;
			}
			rewind(_m8727);
inputState.guessing--;
		}
		if ( synPredMatched8727 ) {
			mOP_COMP(false);
			if ( inputState.guessing==0 ) {
				_ttype = OP_COMP;
			}
			...
			boolean synPredMatched8729 = false;
			if (((LA(1)=='!') && (true))) {
				int _m8729 = mark();
				synPredMatched8729 = true;
				inputState.guessing++;
				try {
					{
					mOP_NOT(false);
					...
					synPredMatched8729 = false;
				}
				rewind(_m8729);
inputState.guessing--;
			}
			if ( synPredMatched8729 ) {
				mOP_NOT(false);
				if ( inputState.guessing==0 ) {
					_ttype = OP_NOT;
				}
